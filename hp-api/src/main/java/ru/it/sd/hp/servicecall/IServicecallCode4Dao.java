 ...
 */
@Repository
public class IServicecallCode4Dao implements HpCrudDao<EntityCode1, IServicecallCode4> {
    ...
    @Override
    public IServicecallCode4 read(long id) {
        try{
            return api.getSdClient().sd_session().getServicecallCode4Home().openServicecallCode4(id);
        }catch (Exception e){
