...
public enum EntityStatus2 {
	...
	CALL_REGISTERED("Зарегистрировано", SERVICECALL, 3094610092L),
	CALL_TO_ENGINEER("Направлено инженеру", SERVICECALL, 281478327763609L),
	CALL_EXECUTING("В работе инженер", SERVICECALL, 281478336938148L),
	CALL_RESOLVED("Решено", SERVICECALL, 3094610094L),
	CALL_CLOSED("Закрыто", SERVICECALL, 3094610096L),
	...
	ITEM_ONSTOCK("На складе", CONFIGURATIONITEM, 3094610398L),
	ITEM_INWORK("В эксплуатации", CONFIGURATIONITEM, 3094610404L),
	ITEM_REPAIRING("Ремонтируется", CONFIGURATIONITEM, 3094610405L),
	ITEM_WRITENOFF("Списано", CONFIGURATIONITEM, 3094610406L),
	ITEM_LOST("Потеряно", CONFIGURATIONITEM, 3094610408L),
