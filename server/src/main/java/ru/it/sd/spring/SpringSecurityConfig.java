...
import ru.it.sd.security.AppAuthenticationManager;
import ru.it.sd.security.RestAuthenticationSuccessHandler;
...
import ru.it.sd.security.RestAuthenticationEntryPoint;
import ru.it.sd.security.RestAuthenticationLogoutHandler;
 ...
 */
@Configuration
@ComponentScan({"ru.it.sd.security"})
@EnableWebSecurity
