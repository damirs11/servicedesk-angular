import templateConfirm from "./confirm.html";
import templateSimple from "./simple.html";
import templateInputMsg from "./input-message.html";

export let uiDialogs = angular
    .module('ui.dialogs', [
