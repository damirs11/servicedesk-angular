...
function SDFactory($injector) {
   ...
   * @type {SD}
   */
  const SD = $injector.instantiate(SDConstructor, {
...
const SDConstructor = function SD($injector, cache) {
  ...
  const RESTEntity = $injector.instantiate(RESTEntityProvider, {
    Entity,
    SD: this
  });
  const EditableEntity = $injector.instantiate(EditableEntityProvider, {
    Entity,
    RESTEntity,
    SD: this
  });
  ...
  locals.AttachmentsHolder = $injector.instantiate(
    AttachmentsHolderProvider,
    locals
  );
  ...
  this.ServiceLevelPriority = $injector.instantiate(
    ServiceLevelPriorityProvider,
    locals
  );
  this.ServiceLevelPriorityDuration = $injector.instantiate(
    ServiceLevelPriorityDurationProvider,
    locals
  );
  ...
  this.ConfigurationItem = $injector.instantiate(
  ...
  this.EntityAssignment = $injector.instantiate(
    EntityAssignmentProvider,
    locals
  );
  ...
  this.EntityClassification = $injector.instantiate(
    EntityClassificationProvider,
    locals
  );
  this.EntityClosureCode = $injector.instantiate(
    EntityClosureCodeProvider,
    locals
  );
