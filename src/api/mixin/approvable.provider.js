...
function ApprovableProvider($connector, SD) {
  ...
  return class Approvable {
    ...
    async getApproverVotes(params) {
      ...
      const votesData = await $connector.get(
        `rest/entity/ApproverVote?entityId=${this.id}`,
        params
      );
    ...
    async getApproverVotesCount(params) {
      ...
      return await $connector.get(
        `rest/entity/ApproverVote/count?entityId=${this.id}`,
        params
      );
    }
     ...
     */
    async getApproval() {
      const approvalData = await $connector.get(
        `rest/entity/Approval/${this.id}`
      );
