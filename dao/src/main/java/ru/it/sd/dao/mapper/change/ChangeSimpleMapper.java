 ...
 */
@Component
public class ChangeSimpleMapper extends EntityRowMapper<Change> {

    private final AssignmentSimpleMapper assignmentMapper;

    public ChangeSimpleMapper(AssignmentSimpleMapper assignmentMapper) {
    ...
    public Change mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        if (managerId != null) {
            Person person = new Person(managerId);
