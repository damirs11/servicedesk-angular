...
public class SpringServiceConfig extends GlobalMethodSecurityConfiguration implements CachingConfigurer {
    ...
    public SpringServiceConfig(SDConfig config) {
        this.config = config;
    }
    ...
    public DataSource dataSource() {
        ...
        ds.setDefaultReadOnly(config.isDbReadonly());
        ds.setMinConnectionsPerPartition(config.getMinConnections());
        ds.setMaxConnectionsPerPartition(config.getMaxConnections());
        ds.setAcquireIncrement(config.getAcquireIncrement());
        ds.setMaxConnectionAge(config.getMaxConnectionAge(), TimeUnit.MINUTES);
        ds.setIdleMaxAge(config.getIdleMaxAge(), TimeUnit.MINUTES);
        ds.setIdleConnectionTestPeriod(config.getIdleConnectionTestPeriod(), TimeUnit.MINUTES);
